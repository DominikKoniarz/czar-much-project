...
const aggregateTodayMeasurements = (
    ...
    return { todayMeasurementsPerHourWh };
};
...
const aggregateLastWeekMeasurements = (
    ...
    everyDayMeasurements.forEach((measurement, index) => {
        ...
        dailyMeasurements.forEach((m) => {
            measurement.totalEnergyFlowWh += m.hourEnergyFlowWh ?? 0;
        });
    });
            ...
            <div className="rounded-lg bg-white p-6 shadow">
                ...
                <div className="space-y-3">
                    ...
                    <div>
                        ...
                        <ul className="mt-2 max-w-[400px] space-y-1">
                            {todayMeasurementsPerHourWh.map(
                                (measurement, index) => (
                                    <li
                                        key={index}
                                        className={cn(
                                            "flex justify-between rounded p-2",
                                            measurement !== null
